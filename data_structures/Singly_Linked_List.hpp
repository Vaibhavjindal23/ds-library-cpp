...
// template <typename T>
// typename SinglyLinkedList<T>::Node* merge_sorted_lists(typename SinglyLinkedList<T>::Node* l1, typename SinglyLinkedList<T>::Node* l2) {
//     if (!l1) return l2;
//     if (!l2) return l1;
//     if (l1->data < l2->data) {
...
// template <typename T>
// typename SinglyLinkedList<T>::Node* merge_sort(Node* head) {
...
//     return merge_sorted_lists<T>(left, right);
// }
...
//     Node* merged = merge_sorted_lists<T>(this->head, other.head);
//     this->head = merged;
